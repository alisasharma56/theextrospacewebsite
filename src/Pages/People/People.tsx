...
//     { name: 'SANJAY PAHARI', role: 'Senior Frontend Developer', image: '/images/people/sanzay.jpg', color: 'cyan',   hexColor: '#22d3ee' },
...
import abhinash  from '../../assets/abhinash.png';
import jayan     from '../../assets/jayan.png';
import subash    from '../../assets/subash.png';
import aasupa    from '../../assets/aasupa.png';
...
const PEOPLE: Person[] = [
    { name: 'ER. JAYAN',     role: 'AI',                       image: jayan,    color: 'purple', hexColor: '#a855f7' },
    { name: 'ER. ABHINASH',  role: 'AI',                       image: abhinash, color: 'pink',   hexColor: '#f472b6' },
    { name: 'SUBASH POUDEL', role: 'AI',                       image: subash,   color: 'cyan',   hexColor: '#22d3ee' },
    { name: 'ER. AASUPA',    role: 'AI',                       image: aasupa,   color: 'green',  hexColor: '#4ade80' },
    { name: 'ALISHA',        role: 'Frontend Developer',       image: alisa,    color: 'pink',   hexColor: '#f472b6' },
    { name: 'NISHA GODAR',   role: 'Admin',                    image: nisha,    color: 'purple', hexColor: '#a855f7' },
    { name: 'SANJAY PAHARI', role: 'Senior Frontend Developer', image: sanjay,  color: 'cyan',   hexColor: '#22d3ee' },
    { name: 'PRABIN GURUNG', role: 'UI/UX Designer',           image: prabin,   color: 'pink',   hexColor: '#f472b6' },
];
                        ...
                        >
                            <div style={{ width: '100%', height: '100%', perspective: '1200px' }}>
                                ...
                                >
                                    ...
                                    <div
                                        className={styles.cardFront}
                                        style={{ boxShadow: `0 0 40px 2px ${person.hexColor}0D inset, 0 10px 40px 0 rgba(0,0,0,0.30)` }}
                                    >
                                        <CornerBrackets color='white' />
                                        <div className={styles.imageWrapper}>
